...
function zabbix_agent_clinets_install () {
...
ansible zabbix-agent-clients -m shell -a 'chmod +x /root/zabbix_rpm_install.sh'
...
echo "zabbix-agent-clients is installed ......."
...
echo "zabbix agnet clients is add open starting ....... "
...
echo "zabbix agent clients install log" >> /etc/ansible/zabbix_agent_clinets_install.log
date >> /etc/ansible/zabbix_agent_clinets_install.log
zabbix_agent_clinets_install >> /etc/ansible/zabbix_agent_clinets_install.log
